...
public class AudioManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (Container.Resolver != null)
            ...
            Debug.LogWarning("[AudioManager] Container.Resolver non trovato.");
    ...
    private void OnDestroy()
    {
        ...
        if (Container.Resolver != null)
            Container.Resolver.UnregisterInstance<AudioManager>();
    }
    ...
    public AudioClip GetClip(string key) => audioDict.TryGetValue(key, out var clip) ? clip : null;
